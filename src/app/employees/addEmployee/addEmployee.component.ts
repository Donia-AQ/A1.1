...
// public departments: DepartmentType[] = [];
  ...
  ngOnInit() {
    this.form = new FormGroup({
      ...
      personalEmail: new FormControl(null, { validators: [Validators.required, Validators.email] }),
       personalMobile: new FormControl(null, { validators: [Validators.required] }),
       workEmail: new FormControl(null, { validators: [Validators.required, Validators.email] }),
       workPhone: new FormControl(null, { validators: [Validators.required,
         Validators.minLength(10),
         Validators.maxLength(10)
      ] }),
       nationality: new FormControl(null, { validators: [Validators.required] }),
       identificationNo: new FormControl(null, { validators: [Validators.required] }),
       passportNo: new FormControl(null, { validators: [Validators.required] }),
       address: new FormControl(null, { validators: [Validators.required] }),
       gender: new FormControl(null, { validators: [Validators.required] }),
       maritalStatus: new FormControl(null, { validators: [Validators.required] }),
       image: new FormControl(null, { validators: [Validators.required], asyncValidators: [mimeType] }),
       jobPosition: new FormControl(null, { validators: [Validators.required] }),
       status: new FormControl(null, { validators: [Validators.required] }),
       jobType: new FormControl(null, { validators: [Validators.required] }),
       salary: new FormControl(null, { validators: [
        Validators.required,
        Validators.min(this.sallaryFrom),
        Validators.max(this.sallaryTo)
       ]}),
       startedDate: new FormControl(null, { validators: [Validators.required] }),
       certificateLevel: new FormControl(null, { validators: [Validators.required] }),
       fieldsOfStudy: new FormControl(null, { validators: [Validators.required] }),
